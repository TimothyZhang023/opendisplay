...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        Console.WriteLine("Supported OS   : Windows 10 / Windows 11 x64");
        ...
        Console.WriteLine($"Window        : {(options.Fullscreen ? "fullscreen" : "windowed")}");
        Console.WriteLine();
        ...
        Console.WriteLine("Press Ctrl+C to stop. Press f inside the video window to toggle fullscreen.");
        Console.WriteLine();
